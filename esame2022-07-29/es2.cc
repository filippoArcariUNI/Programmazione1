...
void estrai_helper(list *  l1,list * l2, list * & l3);
...
void estrai_helper(list *  l1,list * l2, list *& l3){
    if (l1==nullptr)
    {
       return;
        ...
        if ((l1->code%2)==0)
        {
            int occurence=listOccurence(l2,l1->code);
            insert(l3,x,occurence);
            estrai_helper(l1->next,l2,l3);
        }else{
